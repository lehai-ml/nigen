...
If using this package, please cite the following [paper](https://www.nature.com/articles/s41398-023-02413-6)
    ...
    > Le H, Dimitrakopoulou K, Patel H, Curtis C, Cordero-Grande L, Edwards AD, Hajnal J, 
    > Tournier JD, Deprez M, Cullen H. Effect of schizophrenia common variants on infant 
    > brain volumes: cross-sectional study in 207 term neonates in developing Human 
    > Connectome Project. Transl Psychiatry. 2023 Apr 10;13(1):121. doi: 10.1038/
    > s41398-023-02413-6. PMID: 37037832; PMCID: PMC10085987.
